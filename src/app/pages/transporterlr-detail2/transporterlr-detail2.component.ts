...
@Component({
  selector: 'app-transporterlr-detail2',
  templateUrl: './transporterlr-detail2.component.html',
  styleUrls: ['./transporterlr-detail2.component.css']
})
export class TransporterlrDetail2Component implements OnInit {
  public lrDetail: any = {};
  public lr_id:string;
  cookieValue:any;
