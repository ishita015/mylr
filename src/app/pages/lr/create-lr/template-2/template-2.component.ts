...
export class Template2Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lrForm = new FormGroup({
     // transporter_id: new FormControl('1', Validators.required),
      template_id: new FormControl('2', Validators.required),
  ...
  submitLr(lrForm){
    ...
    && this.lrForm.value.from !== '' && this.lrForm.value.to !== '' && this.lrForm.value.in_time !== ''
     ...
     && this.lrForm.value.charged_weight !== '' && this.lrForm.value.length !== '' && this.lrForm.value.width !== ''
     && this.lrForm.value.height !== '' && this.lrForm.value.invoice_date !== '' 
     && this.lrForm.value.invoice_number !== '' && this.lrForm.value.eway_bill_number !== ''
     && this.lrForm.value.vehicle_number !== '' && this.lrForm.value.account_of !== '' && this.lrForm.value.insurance_company !== ''
     && this.lrForm.value.policy_number !== '' && this.lrForm.value.amount !== '' 
     ...
     && this.lrForm.value.charge_details.tbb !== ''  && this.lrForm.value.remark !== ''){ 
